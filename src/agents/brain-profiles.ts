...
export const DEFAULT_BRAIN_PROFILES: Record<string, BrainProfile> = {
  ...
  "openai-api-balanced": {
    ...
    commercialSafe: true,
    notes: "Metered OpenAI API profile available for explicit commercial configs.",
  },
  "openai-codex-subscription-balanced": {
    id: "openai-codex-subscription-balanced",
    label: "Executive Mode OpenAI Codex GPT-5.4",
    provider: "openai-codex",
    model: "gpt-5.4",
    auth: "oauth",
    billing: "subscription",
    ...
    allowMeteredFallback: false,
    commercialSafe: true,
    notes: "Executive Mode default when OpenAI Codex OAuth is available.",
  },
  "openai-api-cheap": {
    id: "openai-api-cheap",
