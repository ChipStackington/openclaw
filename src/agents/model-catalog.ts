...
const OPENAI_CODEX_GPT56_TERRA_MODEL_ID = "gpt-5.6-terra";
const OPENAI_CODEX_GPT56_SOL_MODEL_ID = "gpt-5.6-sol";
...
const SYNTHETIC_CATALOG_FALLBACKS: readonly SyntheticCatalogFallback[] = [
  ...
  {
    provider: CODEX_PROVIDER,
    id: OPENAI_CODEX_GPT56_TERRA_MODEL_ID,
    templateIds: [OPENAI_CODEX_GPT55_MODEL_ID, "gpt-5.4", "gpt-5.3-codex", "gpt-5.2-codex"],
  },
  {
    provider: CODEX_PROVIDER,
    id: OPENAI_CODEX_GPT56_SOL_MODEL_ID,
    templateIds: [OPENAI_CODEX_GPT55_MODEL_ID, "gpt-5.4", "gpt-5.3-codex", "gpt-5.2-codex"],
  },
  {
    provider: CODEX_PROVIDER,
